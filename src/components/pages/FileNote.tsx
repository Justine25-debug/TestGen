...
export default function FileNote() {
  ...
  return (
    ...
    >
      <div className="mt-2 block justify-center rounded-lg border border-dashed border-black px-6 py-6 h-32 w-48 mb-4 float-right">
        <div className="text-center">
          ...
          <div className="mt-4 flex text-sm leading-6 text-zinc-600">
            ...
            >
              <span>{file?.name || `Upload a document`}</span>
              <input
                id="files"
                name="files"
                type="file"
          ...
          {!file && (
            <p className="text-xs leading-5 text-zinc-600"></p>
          )}
        </div>
      </div>
    </label>
